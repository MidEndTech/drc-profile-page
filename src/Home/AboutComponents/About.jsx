...
function About() {
  ...
  return (
    <div   
      ...
      data-aos-offset="300"
      data-aos-once className="mb-[71.75px]">
      <div className="relative flex justify-center items-center min-h-screen px-4 sm:px-8 lg:px-16">
        <div className="relative w-full max-w-[1440px] mx-auto">
          ...
          >
            ...
            >
              كيان استشاري هندسي يحظى بخبرة تراكمية تتجاوز الـ50 عاماً مقرونة
              بفهم عميق للسياق المحلي مكنته من صياغة رؤى استراتيجية وتنفيذ
              مشروعات نوعية في مجالات التخطيط والتصميم العمراني والإدارة
              الهندسية
            </Paragraph>
            <button
